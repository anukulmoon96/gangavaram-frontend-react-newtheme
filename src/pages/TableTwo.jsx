      ...
      <Table sx={{ minWidth: 100 }} size="small" aria-label="a dense table">
        <TableHead style={{backgroundColor: a.state ? '#303134' : 'white'}}>
          <TableRow style={{backgroundColor: a.state ? 'red' : 'red'}}>
            ...
            <TableCell key="wagonsequence" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "wagonsequence"} direction={valueToOrderBy === "wagonsequence" ? orderDirection : "asc"} onClick={createSortHandler('wagonsequence')}>Wagon Sequence</TableSortLabel></TableCell>
            <TableCell key="sackinward" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "sackinward"} direction={valueToOrderBy === "sackinward" ? orderDirection : "asc"} onClick={createSortHandler('sackinward')}>Sack Inward</TableSortLabel></TableCell>
            <TableCell key="sackoutward" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "sackoutward"} direction={valueToOrderBy === "sackoutward" ? orderDirection : "asc"} onClick={createSortHandler('sackoutward')}>Sack Outward</TableSortLabel></TableCell>
            <TableCell key="aggregatebags" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "aggregatebags"} direction={valueToOrderBy === "aggregatebags" ? orderDirection : "asc"} onClick={createSortHandler('aggregatebags')}>Aggregate Bags</TableSortLabel></TableCell>
          </TableRow>
        </TableHead>
