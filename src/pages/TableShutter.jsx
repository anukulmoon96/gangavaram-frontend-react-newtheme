...
export default function TableShutter(props) {
      ...
      <Table sx={{ minWidth: 100 }} size="small" aria-label="a dense table">
        <TableHead style={{backgroundColor: a.state ? '#303134' : 'white'}}>
          <TableRow style={{backgroundColor: a.state ? 'rgb(88, 147, 241)' : 'rgb(88, 147, 241)'}}>
            ...
            <TableCell key="open_time" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "open_time"} direction={valueToOrderBy === "open_time" ? orderDirection : "asc"} onClick={createSortHandler('open_time')}>Open Time</TableSortLabel></TableCell>
            <TableCell key="close_time" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "close_time"} direction={valueToOrderBy === "close_time" ? orderDirection : "asc"} onClick={createSortHandler('close_time')}>Close Time</TableSortLabel></TableCell>
            <TableCell key="image" style={{color:"white"}} align="right"><TableSortLabel active={valueToOrderBy === "image"} direction={valueToOrderBy === "image" ? orderDirection : "asc"} onClick={createSortHandler('image')}>Image</TableSortLabel></TableCell>
          </TableRow>
        </TableHead>
        <TableBody style={{backgroundColor:  a.state ? '#303134' : 'white'}}>
          {props.data && (rowsPerPage > 0
            ...
            >
              ...
              <TableCell align="right" style={{color: a.state ? "white" : "black"}}>{row.open_time}</TableCell>
              <TableCell align="right" style={{color: a.state ? "white" : "black"}}>{row.close_time}</TableCell>
              <TableCell align="right" style={{color: a.state ? "white" : "black"}}><center><img onClick={function(){handleOpen();setImage(row.image)}} style={{height:"100px",width:"100px",cursor:"pointer"}} src={row.image}/></center></TableCell>
            </TableRow>
          ))}
